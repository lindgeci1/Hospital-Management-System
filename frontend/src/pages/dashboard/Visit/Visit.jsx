...
function Visit({ showCreateForm, setShowCreateForm, showUpdateForm, setShowUpdateForm, setSelectedVisitId }) {
    ...
    }, [ location.state, setShowCreateForm]); // Adding dependencies (token, location.state, setShowCreateForm)
    ...
    const handleDeleteConfirm = async () => {
        try {
            await axios.delete(`http://localhost:9004/api/visit/delete/${deleteVisitId}`, { withCredentials: true });
