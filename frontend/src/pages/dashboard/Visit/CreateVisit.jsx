...
import { Box, TextField, Button, Typography, Select, MenuItem, Grid, InputLabel, FormControl, Modal, FormHelperText } from '@mui/material';
...
function CreateVisit({ onClose }) {
    ...
    const fetchDoctors = async () => {
        try {
            const response = await axios.get('http://localhost:9004/api/doctors', { withCredentials: true });
    ...
    const handleAddVisit = async () => {
        try {
            const response = await axios.post('http://localhost:9004/api/visit/create', formData, { withCredentials: true });
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={6}>
                            ...
                            <FormControl fullWidth variant="outlined" margin="dense">
                                ...
                                <FormHelperText>Select the doctor for the this visit</FormHelperText>
                            </FormControl>
