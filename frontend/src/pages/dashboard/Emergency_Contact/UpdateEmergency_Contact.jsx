...
function UpdateEmergency_Contact({ id, onClose }) {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`http://localhost:9004/api/emergency_contact/${id}`, { withCredentials: true });
    ...
    const handleUpdateContact = async () => {
        ...
        // }
        try {
            await axios.put(`http://localhost:9004/api/emergency_contact/update/${id}`, formData, { withCredentials: true });
            onClose();
