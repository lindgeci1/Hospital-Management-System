...
function UpdateMedicalHistory({ id, onClose }) {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get(`http://localhost:9004/api/medicalhistory/${id}`, { withCredentials: true });
    ...
    const handleValidation = async () => {
        ...
        try {
            ...
            const patientResponse = await axios.get(`http://localhost:9004/api/patient/${Patient_ID}`, { withCredentials: true });
            ...
            // Perform the update
            await axios.put(`http://localhost:9004/api/medicalhistory/update/${id}`, formData, { withCredentials: true });
