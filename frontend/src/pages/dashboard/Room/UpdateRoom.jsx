...
function UpdateRoom({ id, onClose }) {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                const response = await axios.get(`http://localhost:9004/api/room/${id}`,{ withCredentials: true });
                ...
                const patientResponse = await axios.get(`http://localhost:9004/api/patient/${responseData.Patient_ID}`, { withCredentials: true });
    ...
    const handleUpdateRoom = async () => {
        ...
        try {
            ...
            // Update the room
            await axios.put(`http://localhost:9004/api/room/update/${id}`, formData,{ withCredentials: true });
