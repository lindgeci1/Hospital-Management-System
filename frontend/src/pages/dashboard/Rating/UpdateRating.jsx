...
function UpdateRating({ id, onClose }) {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get(`http://localhost:9004/api/rating/${id}`,  { withCredentials: true });
    ...
    const fetchExistingRatings = async () => {
        try {
            const response = await axios.get('http://localhost:9004/api/rating',  { withCredentials: true });
    ...
    const fetchStaffEmail = async (empId) => {
        try {
            const response = await axios.get(`http://localhost:9004/api/staff/${empId}`,  { withCredentials: true });
