...
function CreateDoctor({ onClose }) {
    ...
    const fetchDoctors = async () => {
        try {
            const response = await axios.get('http://localhost:9004/api/staff/doctors', { withCredentials: true });
    ...
    const handleAddDoctors = async () => {
        try {
            await axios.post("http://localhost:9004/api/doctors/create", formData, { withCredentials: true });
