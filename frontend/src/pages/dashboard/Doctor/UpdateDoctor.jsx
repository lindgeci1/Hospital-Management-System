...
function UpdateDoctor({ id, onClose }) {
    ...
    const fetchDoctorDetails = async () => {
        try {
            ...
            const response = await axios.get(`http://localhost:9004/api/doctors/${id}`, { withCredentials: true });
    ...
    const handleValidation = async () => {
        ...
        try {
            await axios.put(`http://localhost:9004/api/doctors/update/${id}`, formData, { withCredentials: true });
