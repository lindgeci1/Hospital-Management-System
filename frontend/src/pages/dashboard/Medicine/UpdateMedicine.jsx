...
function UpdateMedicine({ id, onClose }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`http://localhost:9004/api/medicine/${id}`, { withCredentials: true });
    ...
    const handleUpdateMedicine = async () => {
        ...
        try {
            await axios.put(`http://localhost:9004/api/medicine/update/${id}`, formData, { withCredentials: true });
